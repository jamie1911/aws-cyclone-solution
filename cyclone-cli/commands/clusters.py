...
@click.option('--compute-resources-tags', type=(str, int), multiple=True, default={}, required=False, help='Assign tags for cluster, Repeat for multiple tags e.g "--compute-resource-tags TAGKEY1 TAGVALUE1 --compute-resource-tags TAGKEY2 TAGVALUE2".')
...
@click.option('--compute-resources-tags', multiple=True, default=None, required=False, help='Assign tags for cluster, Repeat for multiple tags e.g "--compute-resource-tags TAGKEY1 TAGVALUE1 --compute-resource-tags TAGKEY2 TAGVALUE2".')
...
def update_cluster(obj, name, instance_list, max_vcpus, bid_percentage, type, allocation_strategy, iam_policies, compute_resources_tags, main_region_image_name):
    ...
    if not compute_resources_tags == None:
        compute_resources_tags_dict = {}
        for item in compute_resources_tags:
            k, v = item
            compute_resources_tags_dict[k] = v
